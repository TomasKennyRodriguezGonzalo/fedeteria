use datos_comunes::{QueryAddOffice, ResponseAddOffice, ResponseGetOffices, Sucursal};
use yew::prelude::*;
use reqwasm::http::Request;
use wasm_bindgen_futures::spawn_local;

use crate::{components::{generic_button::GenericButton, generic_input_field::GenericInputField}, molecules::confirm_prompt_button_molecule::ConfirmPromptButtonMolecule};
